...
function AppTitle() {
  ...
  return (
    <div className="flex flex-col gap-y-4 px-2.5 max-sm:w-full max-sm:gap-y-6 max-sm:px-0">
      <h1 className="whitespace-pre-line text-2xl font-black uppercase tracking-[0.1em] text-primary dark:text-primary-dark max-md:text-xl">
        {t('title')}
      </h1>
...
function Platforms() {
  ...
  return (
    <ul className="flex h-min w-80 flex-col items-center gap-y-3 rounded-lg bg-white/50 pb-4 dark:bg-black/50 max-md:text-sm max-sm:w-11/12 max-sm:self-start max-sm:bg-accent max-sm:dark:bg-accent-dark">
