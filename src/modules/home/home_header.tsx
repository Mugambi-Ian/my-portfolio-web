...
function HomeTitle() {
  ...
  return (
    <div className="flex flex-col gap-y-4 px-2.5 max-sm:w-full max-sm:gap-y-6 max-sm:px-0">
      <h1 className="text-2xl font-black uppercase tracking-[0.1em] text-primary dark:text-primary-dark">
        {t('title')}
      </h1>
      <h2 className="whitespace-pre-line text-2xl font-black uppercase tracking-[0.1em] text-black dark:text-white">
        {t('subtitle')}
      </h2>
      <p className="whitespace-pre-line text-base font-normal leading-[160%] tracking-[0.05em] text-black dark:text-white">
        {t('p')}
      </p>
    </div>
  );
...
function Platforms() {
  ...
  return (
    <ul className="flex h-min w-80 flex-col items-center gap-y-3 rounded-lg bg-white/50 pb-4 dark:bg-black/50 max-sm:w-full max-sm:bg-accent max-sm:dark:bg-accent-dark">
      <p className="w-full rounded-t-lg bg-primary p-2.5 text-center font-medium tracking-[0.02em] text-white dark:bg-primary-dark">
        {t('title')}
      </p>
